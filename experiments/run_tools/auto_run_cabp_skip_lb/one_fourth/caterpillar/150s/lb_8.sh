...
LOG_DIR="../../../../../../experiments/results/logs_150s_skip_lb_one_fourth/unknow_optimal/caterpillar/binarysearchfromLB_highestdegree_8workers"
ADD_CONFIGS="--binary-search-from-lb -lb-skip-threshold 0.25"
