...
LOG_DIR="../../../../../../experiments/results/logs_150s_skip_lb_one_fourth/unknow_optimal/caterpillar/binarysearchfromUB_highestdegree_4workers"
ADD_CONFIGS="--binary-search-from-ub -lb-skip-threshold 0.25"
